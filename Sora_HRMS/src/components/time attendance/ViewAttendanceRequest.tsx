...
const ViewAttendanceRequest = ({
  ...
  attendanceItem: IAttendanceRequest;
}) => {
  return (
      ...
      <View className="flex-row justify-between items-center">
        <View className="flex-row gap-2">
          <Image
            ...
            source={{ uri: attendanceItem.image }}
          />
          <View>
            <Text className="font-semibold text-lg text-textPrimary">
              {attendanceItem.employeeName}
            </Text>
            <Text className="text-textSecondary">
              {attendanceItem.designation}
            </Text>
          </View>
        </View>
        <Text
      ...
      <View className="py-4 gap-6">
        <View className="w-full gap-2">
          <View className="flex-row w-full">
            <Text className="flex-1 text-lg text-textPrimary">Date</Text>
            <Text className="flex-1 text-lg text-textPrimary">In Time</Text>
